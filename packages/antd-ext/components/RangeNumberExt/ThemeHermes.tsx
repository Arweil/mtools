...
import { colorPrimaryL2, colorError, colorWarning, colorSuccess, colorGreyL1 } from '../theme/hermes';
...
export const customStyleWithRangeNumberOutLineExt = (token: GlobalToken, prefixCls: string) => css`
`;

export function ThemeHermesWithRangeNumberOutLineExt(props: ThemeHermesWithRangeNumberOutLineExtProps) {
  const { children } = props;

...
export interface SelectSelectProps {
  ...
  onChange?: (
    params: { selectValueBefore?: SelectValue; selectValueAfter?: SelectValue }
  ) => void; // 重写onChange事件
}
...
export default class SelectSelect extends PureComponent<SelectSelectProps, SelectSelectState> {
  ...
  render(): JSX.Element {
    const {
      selectPropsBefore, selectPropsAfter, showSelectBefore, showSelectAfter,
    } = this.props;

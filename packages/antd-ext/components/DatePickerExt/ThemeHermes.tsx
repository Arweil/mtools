...
import { colorBlackL2, colorBlackL4, colorError, colorGreyL3, colorGreyL5, colorPrimaryL1, colorPrimaryL2, colorSuccess, colorWarning, colorWeakPrimary } from '../theme/hermes';
...
export const customPopupStyle = (token: GlobalToken, prefixCls: string) => css`
  &.${prefixCls}-picker-dropdown .${prefixCls}-picker-year-panel .${prefixCls}-picker-cell-inner,
  &.${prefixCls}-picker-dropdown .${prefixCls}-picker-quarter-panel .${prefixCls}-picker-cell-inner,
  &.${prefixCls}-picker-dropdown .${prefixCls}-picker-month-panel .${prefixCls}-picker-cell-inner {
    width: 48px;
    height: 48px;
    line-height: 48px;
    padding: 0;

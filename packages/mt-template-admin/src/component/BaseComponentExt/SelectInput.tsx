...
export interface SelectInputProps {
  ...
  onChange?: (
    params: { selectValue?: SelectValue; inputValue?: InputValueType }
  ) => void; // 重写onChange事件
}
...
export default class SelectInput
  extends PureComponent<SelectInputProps, SelectInputState> {
  ...
  static getDerivedStateFromProps(
    nextProps: SelectInputProps,
  ): SelectInputState | null {

...
import type { RangePickerProps, QuarterPicker, YearPicker, MonthPickerProps, WeekPicker, TimePicker } from './type';
...
export default function MixinDatePicker(props: MixinDatePickerExtProps) {
  return (
    <MixHOC {...props}>
      {
        (classes, _popupClassName) => <DatePicker
          style={{ width: '100%' }}
          {...props}
          className={classes}
...
MixinDatePicker.RangePicker = (props: MixinRangePickerExtProps) => {
  return (
    <MixHOC {...props}>
      {
        (classes, _popupClassName) => <DatePicker.RangePicker
          style={{ width: '100%' }}
          {...props}
          className={classes}
          popupClassName={_popupClassName}
...
MixinDatePicker.QuarterPicker = (props: MixinQuarterPickerExtProps) => {
  return (
    <MixHOC {...props}>
      {
        (classes, _popupClassName) => <DatePicker.QuarterPicker
          style={{ width: '100%' }}
          {...props}
          className={classes}
          popupClassName={_popupClassName}
...
MixinDatePicker.YearPicker = (props: MixinYearPickerExtProps) => {
  return (
    <MixHOC {...props}>
      {
        (classes, _popupClassName) => <DatePicker.YearPicker
          style={{ width: '100%' }}
          {...props}
          className={classes}
          popupClassName={_popupClassName}
...
MixinDatePicker.MonthPicker = (props: MixinMonthPickerExtProps) => {
  return (
    <MixHOC {...props}>
      {
        (classes, _popupClassName) => <DatePicker.MonthPicker
          style={{ width: '100%' }}
          {...props}
          className={classes}
          popupClassName={_popupClassName}
...
MixinDatePicker.WeekPicker = (props: MixinWeekPickerExtProps) => {
  return (
    <MixHOC {...props}>
      {
        (classes, _popupClassName) => <DatePicker.WeekPicker
          style={{ width: '100%' }}
          {...props}
          className={classes}
          popupClassName={_popupClassName}
...
MixinDatePicker.TimePicker = (props: MixinTimePickerExtProps) => {
  return (
    <MixHOC {...props}>
      {
        (classes, _popupClassName) => <DatePicker.TimePicker
          style={{ width: '100%' }}
          {...props}
          className={classes}
          popupClassName={_popupClassName}
